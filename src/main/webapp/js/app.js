function company($scope, $http) {
	$scope.add = function() {
		var req = {
			method : 'GET',
			url : 'rest/company/add?name=' + document.getElementById("add-company-name").value + '&address=' + document
					...
					.getElementById("add-company-phone").value,
		};
	...
	$scope.update = function() {
		var req = {
			method : 'GET',
			url : 'rest/company/update?id=' + document.getElementById("update-company-id").value + '&name=' + document
	...
	$scope.addEmployee = function() {
		var req = {
			method : 'GET',
			url : 'rest/company/add-employee?company-id=' + document.getElementById("add-employee-id").value + '&employee-name=' + document
	...
	$scope.addOwner = function() {
		var req = {
			method : 'GET',
			url : 'rest/company/add-owner?company-id=' + document.getElementById("add-owner-id").value + '&owner-name=' + document
